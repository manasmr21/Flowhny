...
function ProductPage() {
  ...
  useEffect(() => {
    filterProducts();
  }, [selectedCategory, selectedPriceRanges. product]);
  ...
  return (
    <div className=" w-full dark:bg-themedark">
          ...
          >
            ...
            <div className="relative">
              ...
              <div
                ...
                className="w-full dark:bg-[#1b1b1b] dark:text-white p-3 rounded-sm bg-gray-100 flex justify-between items-center cursor-pointer border border-gray-200 hover:border-themegreen"
              >
            ...
            <div>
              <label className="block my-2 dark:text-white font-medium text-gray-700">
                Price Range
              </label>
              <div className="flex flex-col gap-3">
                {priceRanges.map((range) => (
                  <label
                    key={range.label}
                    className="flex dark:bg-[black] dark:text-white items-center gap-3 p-2 bg-gray-100 rounded-sm hover:bg-themegreen  hover:text-white transition cursor-pointer shadow-sm "
                  >
                    <input
                      type="checkbox"
